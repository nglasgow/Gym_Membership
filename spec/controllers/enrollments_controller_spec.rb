...
describe EnrollmentsController do
  ...
  describe "GET index" do
    it "assigns all enrollments as @enrollments" do
      ...
      assigns(:enrollments).should eq([enrollment])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created enrollment" do
        post :create, {:enrollment => valid_attributes}, valid_session
        response.should redirect_to(Enrollment.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved enrollment as @enrollment" do
        ...
        post :create, {:enrollment => { "type" => "invalid value" }}, valid_session
        assigns(:enrollment).should be_a_new(Enrollment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested enrollment" do
        ...
        Enrollment.any_instance.should_receive(:update_attributes).with({ "type" => "" })
        put :update, {:id => enrollment.to_param, :enrollment => { "type" => "" }}, valid_session
      end
      ...
      it "redirects to the enrollment" do
        enrollment = Enrollment.create! valid_attributes
        put :update, {:id => enrollment.to_param, :enrollment => valid_attributes}, valid_session
        response.should redirect_to(enrollment)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the enrollment as @enrollment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Enrollment.any_instance.stub(:save).and_return(false)
        put :update, {:id => enrollment.to_param, :enrollment => { "type" => "invalid value" }}, valid_session
        assigns(:enrollment).should eq(enrollment)
      end
